               ...
               server:(HTTPServer *)aServer
{
	...
	if (self != nil)
	{
        ...
        // TODO freynaud ugly workaround to avoid using waitForDataInBackgroundAndNotify.
...
- (void)startResponse
{
	...
	@try
	{
        CFHTTPMessageSetBody( response,   (CFDataRef)content);
        page = CFHTTPMessageCopySerializedMessage(response);
		[fileHandle writeData:(NSData *)page];
